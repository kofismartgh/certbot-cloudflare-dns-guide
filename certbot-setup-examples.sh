...
echo "2. Certbot is installed (see README-certbot-setup.md for installation)"
echo "3. Cloudflare API token is configured"
echo "4. Domains point to your server"
echo "5. Firewall allows ports 80 and 443"
echo "6. Platform-specific dependencies are installed:"
echo "   - Ubuntu/Debian: python3-dev libaugeas-dev"
echo "   - Amazon Linux: python3-devel libffi-devel openssl-devel"
echo "   - CentOS/RHEL: epel-release python3-devel libffi-devel openssl-devel"
echo
